...
bot = telebot.TeleBot('7900112910:AAG_XTgMOF-OeBEq0aSZP9XWZRCy2KjbhDM')
...
def check_balance(message):
    ...
    if user_id in resellers:
        ...
        response = "⛔️ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗻𝗱: 𝗿𝗲𝘀𝗲𝗹𝗹𝗲𝗿 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱"
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 ┊⪼ꮇá𝗅áɏáļḭ⪻┊™ Dildos 𝗯𝗼𝘁!", reply_markup=markup)

COOLDOWN_PERIOD = 2 * 60  # 2 minutes
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if time > 240:
                ...
                response = f"🚀 𝗔𝘁𝘁𝗮𝗰𝗸 𝗦𝗲𝗻𝘁 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝗻𝗹𝗹𝘆! 🚀\n\n𝗧𝗮𝗿𝗴𝗲𝘁: {target}:{port}\n𝗧𝗶𝗺𝗲: {time} 𝘀𝗲𝗰𝗼𝗻𝗱𝘀\n𝗔𝘁𝘁𝗮𝗰𝗸𝗲𝗿: @{username}"
...
def show_resellers(message):
    ...
    if user_id in admin_id:
        ...
        resellers_info = "✅ 𝗔𝘂𝘁𝗵𝗼𝗿𝗶𝘇𝗲𝗱 𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿𝘀 ✅\n\n"
